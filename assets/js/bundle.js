...
/***/ function(module, exports, __webpack_require__) {
	...
	ReactDOM.render(React.createElement(App, null), document.getElementById('vr'));
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        "a-scene",
	        null,
	        React.createElement("a-sphere", { position: "0 1.25 -1", radius: "1.25", color: "#EF2D5E" }),
	        React.createElement("a-cube", { position: "-1 0.5 1", rotation: "0 45 0", width: "1", height: "1", depth: "1", color: "#4CC3D9" }),
	        React.createElement("a-cylinder", { position: "1 0.75 1", radius: "0.5", height: "1.5", color: "#FFC65D" }),
	        React.createElement("a-plane", { rotation: "-90 0 0", width: "4", height: "4", color: "#7BC8A4" }),
	        React.createElement("a-sky", { color: "#ECECEC" })
	      )
	    );
	  }
	});
